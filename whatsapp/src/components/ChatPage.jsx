        ...
        <Row className="chatRow" id="chatBody">
            <div className="chatBody-childDiv py-2 ">
                {chat.current_chat_room.chats?.length > 0 ? (
                    ...
                    <div>
                        <p className="py-4 ">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium, eos quo! Accusamus recusandae repudiandae, eum quae at totam culpa explicabo! Quae recusandae aliquid
                            error pariatur in nobis animi, enim quasi.
                        </p>
                    </div>
                )}
            </div>
